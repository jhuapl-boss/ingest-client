...
class ZImageStackMixin(object):
    ...
    def test_TileProcessor_process(self):
        ...
        # Open original data
        truth_file = os.path.join(resource_filename("ingest", "test/data/example_z_stack/"), "3253_my_stack_section000.png")
...
class TestZImageStackLocal(ZImageStackMixin, unittest.TestCase):
    ...
    def test_PathProcessor_setup(self):
        ...
        assert pp.parameters["root_dir"] == resource_filename("ingest", "test/data/example_z_stack")
    ...
    @classmethod
    def setUpClass(cls):
        cls.config_file = os.path.join(resource_filename("ingest", "test/data"), "boss-v0.1-zStack.json")
...
class TestZImageStackS3(ZImageStackMixin, unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        # Put images in S3
        imgs = [os.path.join(resource_filename("ingest", "test/data/example_z_stack"), "3253_my_stack_section000.png"),
                os.path.join(resource_filename("ingest", "test/data/example_z_stack"), "3254_my_stack_section001.png")]
